...
@section('content')
    <div class="payment" style="background-color:rgba(0,0,0,.05);">
        <div class="payment-left" style="width:70%;">
            <div style="height:80%;">
        ...
        <div class="payment-right" style="background-color: white; box-shadow: -2px -2px 10px rgba(0,0,0,.1); margin:1rem; padding:1rem;">
            <div>
                <p>Lista på saker som ska va här i ordning</p>
                <ul>
                    <li><p>Rabattkod</p></li>
                    <li><p>Beställningsvärde</p></li>
                    <li><p>Leveranskostnad</p></li>
                    <li><p>Total</p></li>
                    <li><b>Klicka här för checkout</b></li>
                    <li><p>Proceed to checkout <a href="{{route('payment.checkout') }}">här</a></p></li>
                    <li><p>"Vi tar emot betalningssätt(klarna widget)"</p></li>
                    <li><p>Priser och fraktavgift bekräftas inte förrän i kassan.
                        30 dagars ångerrätt. Läs om returer och återbetalning.</p></li>
                </ul>
            </div>
        </div>
    </div>
